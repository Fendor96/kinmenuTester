...
<html>
    ...
    <body>
        <section>
            ...
            <p>Il semblerait que l'adresse Email que vous avez entré n'existe pas !</p>

            <div class="img"></div>

            <a href="../Pages/signup.html">Créer un compte ?</a>
            <a href="../Pages/login.html">Continuer avec une autre adresse mail</a>
